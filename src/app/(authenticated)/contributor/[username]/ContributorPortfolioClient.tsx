...
interface ContributorPortfolioClientProps {
  username: string;
}

export default function ContributorPortfolioClient({ username }: ContributorPortfolioClientProps) {
  ...
  // If no username provided, show a fallback message
        ...
        <div className="bg-white rounded-lg shadow-sm border p-8 mb-8">
          <div className="text-center">
            ...
            <p className="text-gray-700 leading-relaxed max-w-2xl mx-auto mb-6">
              Start building your portfolio by uploading your first prompt! This is your space to showcase your creative work and connect with other prompt creators.
            </p>
